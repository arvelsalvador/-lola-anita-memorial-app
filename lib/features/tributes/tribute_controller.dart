...
import 'package:nita/features/tributes/tribute_model.dart';
...
class TributeController extends ChangeNotifier {
  static const TributeModel data = TributeModel(
    ...
    familyQuotes: [
      ...
      FamilyQuote(
        quote: 'She never let us leave hungry or unloved. That was her superpower.',
        name: 'Carlo, grandson',
      ),
      FamilyQuote(
        quote: 'I will spend my whole life trying to love people the way she loved us.',
